...
export const tracks: Track[] = [
  ...
  { id: 'W5CD1', wave: 'V', cd: 1, title: '探索 #1', url: u('W5CD1') },
  { id: 'W5CD2', wave: 'V', cd: 2, title: '探索 #2', url: u('W5CD2') },
  { id: 'W5CD3', wave: 'V', cd: 3, title: '探索 #3', url: u('W5CD3') },

  // Special Wave V (English folder example). Adjust folder naming if needed.
  { id: 'W5EN-CD1', wave: 'V-EN', cd: 1, title: 'Exploration V EN #1', url: u('WaveV_EN/CD1') },
  { id: 'W5EN-CD2', wave: 'V-EN', cd: 2, title: 'Exploration V EN #2', url: u('WaveV_EN/CD2') },
  { id: 'W5EN-CD3', wave: 'V-EN', cd: 3, title: 'Exploration V EN #3', url: u('WaveV_EN/CD3') },
];
